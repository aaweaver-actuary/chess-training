...
/// Strongly typed identifier for stored chess positions.
///
/// # Examples
/// ```rust
...
impl TryFrom<u128> for PositionId {
...
impl TryFrom<i128> for PositionId {
    type Error = IdConversionError;
...
impl TryFrom<i64> for PositionId {
    type Error = IdConversionError;
